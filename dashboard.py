...
# ==========================================
BLYNK_AUTH_TOKEN = "zW9oV9_a-PD7IXvfZ2b-8uhT8OgiEz8x"  # Masukkan Auth Token Blynk anda
...
for i, dev in enumerate(devices):
    with cols[i]:
        ...
        # Baca nilai terkini dari Blynk sekali sahaja bagi setiap render
        ...
        # Hantar arahan ke Blynk & refresh serta-merta HANYA jika pengguna klik toggle
